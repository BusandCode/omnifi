    ...
    <View style={styles.card}>
      <View style={styles.headerRow}>
        ...
        <TouchableOpacity style={styles.idRow} onPress={handleCopyId}>
          ...
          <Feather name="copy" size={11} color={colors.primaryLight} style={{ marginLeft: 4 }} />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  idLabel: { color: colors.textSecondary, fontSize: 9.5 },
  idValue: { color: colors.primaryLight, fontSize: 9.5, fontWeight: '700' },
  ...
  recipientName: { color: colors.textPrimary, fontSize: 12.5, fontWeight: '700' },
  recipientSub: { color: colors.textSecondary, fontSize: 9.5, marginTop: 1 },
  ...
  accountBadgeText: { color: colors.primaryLight, fontSize: 9.5, fontWeight: '700' },
  accountFlag: { fontSize: 11 },
  inlineRow: { flexDirection: 'row', marginTop: 4 },
  inlineLabel: { color: colors.textSecondary, fontSize: 10 },
  inlineValue: { flex: 1, color: colors.textPrimary, fontSize: 10, fontWeight: '600' },
});
  ...
  const categories: Category[] = useMemo(
    () => [
      ...
      },
      {
        ...
        arrowColor: themeColors.success,
      },
      {
        id: 'safety',
  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        title: { color: themeColors.textPrimary, fontSize: 10, fontWeight: '600', marginBottom: 6, textAlign: 'center', width: '100%' },
        sub: { color: themeColors.textSecondary, fontSize: 9, lineHeight: 13, textAlign: 'center', width: '100%' },

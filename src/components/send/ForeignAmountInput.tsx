  ...
  const { styles, iconSize } = useMemo(() => {
    ...
    return {
      ...
      styles: StyleSheet.create({
        ...
        maxBtn: {
          borderWidth: 1, borderColor: colors.primary, borderRadius: s(8),
          paddingHorizontal: s(9), paddingVertical: s(4),
        },
        maxText: { color: colors.primaryLight, fontSize: f(9.5), fontWeight: "700" },
        amountRow: { flexDirection: "row", alignItems: "center", gap: s(5), marginVertical: s(10) },
        symbol: { color: colors.textPrimary, fontSize: f(24), fontWeight: "700" },
        input: { flex: 1, color: colors.textPrimary, fontSize: f(24), fontWeight: "700", padding: 0 },
        footerRow: { flexDirection: "row", justifyContent: "space-between" },
        footerLabel: { color: colors.textSecondary, fontSize: f(9) },
        footerValue: { color: colors.textPrimary, fontSize: f(9), fontWeight: "600" },
      }),
    };
  }, [layoutScale]);
    ...
    return {
      ...
      styles: StyleSheet.create({
        row: {
          ...
          backgroundColor: colors.surface, borderRadius: s(12),
          paddingHorizontal: s(11), paddingVertical: s(10),
        },
        input: { flex: 1, color: colors.textPrimary, fontSize: f(11) },
        count: { color: colors.textSecondary, fontSize: f(9) },
      }),
    };
  }, [layoutScale]);

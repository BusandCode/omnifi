...
export function WalletBalanceCard() {
  ...
  const { styles, iconSize } = useMemo(() => {
    ...
    return {
      ...
      styles: StyleSheet.create({
        ...
        label: { color: 'rgba(255,255,255,0.7)', fontSize: f(11) },
        amountRow: { 
          flexDirection: 'row', 
          alignItems: 'center', 
          gap: s(3), 
        ...
        currency: { color: '#fff', fontSize: f(15), fontWeight: '700' },
        amount: { color: '#fff', fontSize: f(16), fontWeight: '700' },
        sub: { color: 'rgba(255,255,255,0.5)', fontSize: f(9.5), marginBottom: s(8) },
        ...
        changeText: { color: colors.success, fontSize: f(9.5), fontWeight: '700' },
        changeSub: { color: 'rgba(255,255,255,0.5)', fontSize: f(9.5) },
        ...
        coinSymbol: { color: '#fff', fontSize: f(15), fontWeight: '800' },
        coinSymbolSmall: { color: '#fff', fontSize: f(12), fontWeight: '800' },
  ...
  return (
    <TouchableOpacity style={styles.wrapper} activeOpacity={0.9}>
      ...
      <Feather name="chevron-right" size={iconSize + 2} color="rgba(255,255,255,0.5)" style={styles.chevron} />
    </TouchableOpacity>
  );
}
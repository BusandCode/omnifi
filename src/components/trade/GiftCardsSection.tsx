...
const giftCards: GiftCard[] = [
  {
    ...
    from: "₦480 / $1",
    bg: "#1A1A1A",
    icon: <FontAwesome5 name="amazon" size={18} color="#fff" />,
  },
  {
    id: "apple",
    name: "Apple",
  ...
  },
  {
    ...
    from: "₦450 / $1",
    bg: "#1B2838",
    icon: <FontAwesome5 name="steam" size={16} color="#fff" />,
  },
  {
    id: "googleplay",
    name: "Google Play",
    from: "₦470 / $1",
    bg: "#0F3D2E",
    icon: <Ionicons name="logo-google-playstore" size={16} color="#fff" />,
  },
];
  ...
  const { styles, iconSize } = useMemo(() => {
    ...
    return {
      ...
      styles: StyleSheet.create({
        ...
        cardFromLabel: { color: "rgba(255,255,255,0.7)", fontSize: f(8) },
        cardFrom: {
          color: "#fff",
          fontSize: f(10),
          fontWeight: "600",
    ...
    <View>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.sub}>
            Buy, sell and trade gift cards instantly
          </Text>
        </View>
      ...
      >
        {giftCards.map((g) => (
          <TouchableOpacity
            key={g.id}
            style={[styles.card, { backgroundColor: g.bg }]}
          >

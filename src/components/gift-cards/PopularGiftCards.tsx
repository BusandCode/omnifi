// src/components/gift-cards/PopularGiftCards.tsx
...
const cards: Card[] = [
  ...
  { id: 'googleplay', name: 'Google Play', from: '₦470 / $1', bg: '#0F3D2E', icon: <Ionicons name="logo-google-playstore" size={18} color="#fff" /> },
  {
    ...
    from: '₦600 / $1',
    bg: '#2A0A0A',
    icon: <Text style={{ color: '#E50914', fontSize: 22, fontWeight: '900' }}>N</Text>,
  },
];
  ...
  return (
    <View>
      <View style={styles.header}>
        <Text style={[styles.title, { color: themeColors.textPrimary }]}>Popular Gift Cards</Text>
        <TouchableOpacity style={styles.viewAll}>
          <Text style={[styles.viewAllText, { color: themeColors.primaryLight }]}>View All</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  viewAllText: { fontSize: 10.5, fontWeight: '600' },
  row: { gap: 10 },
  ...
  fromValue: { color: '#fff', fontSize: 10.5, fontWeight: '600', marginTop: 1, textAlign: 'center' },
});
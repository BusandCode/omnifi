...
const stocks: Stock[] = [
  {
    ...
    logo: "local",
    localLogo: APPLE_LOGO,
    price: "$189.84",
    change: "2.35%",
    up: true,
    sparkline: "M0,20 10,18 20,15 30,17 40,10 50,12 60,5 70,8 80,2",
  },
  {
    name: "Tesla, Inc.",
    ticker: "TSLA • US Stock",
    logo: "remote",
    logoUri: "https://logo.clearbit.com/tesla.com",
    price: "$217.41",
    change: "3.21%",
    up: true,
    sparkline: "M0,18 10,20 20,12 30,14 40,8 50,10 60,4 70,6 80,1",
  },
  {
    name: "MTN Nigeria",
    ticker: "MTNN • Nigerian Stock",
    logo: "local",
    localLogo: MTN_LOGO,
    price: "NGN 240.00",
    change: "1.48%",
    up: true,
    sparkline: "M0,15 10,17 20,14 30,16 40,11 50,13 60,7 70,9 80,4",
  },
  {
    name: "SPDR Gold Trust",
    ticker: "GLD • ETF",
    logo: "remote",
    logoUri: "https://logo.clearbit.com/ssga.com",
    price: "$214.11",
    change: "0.85%",
    up: true,
    sparkline: "M0,16 10,15 20,17 30,13 40,14 50,10 60,11 70,7 80,6",
  },
];
    ...
    <View style={styles.wrapper}>
      ...
      <View style={styles.card}>
        {stocks.slice(0, 3).map((stock, i) => (
          <View
            key={stock.ticker}
            style={[styles.row, i !== 2 && styles.divider]}
          >
            <View style={styles.left}>
              {stock.logo === "local" && stock.localLogo ? (
                <Image
                  source={stock.localLogo}
                  style={styles.logo}
                  resizeMode="contain"
                />
              ) : (
            ...
            <View style={{ alignItems: "flex-end" }}>
              ...
              <View style={styles.changeRow}>
                <Feather
                  ...
                  size={arrowSize}
                  color={stock.up ? themeColors.success : themeColors.danger}
                />
                <Text
                  style={[
                    styles.change,

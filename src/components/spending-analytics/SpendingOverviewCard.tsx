...
const styles = StyleSheet.create({
  ...
  centerLabel: { color: colors.textSecondary, fontSize: 10 },
  centerAmount: { color: colors.textPrimary, fontSize: 10, fontWeight: '800', marginTop: 2 },
  centerPercent: { color: colors.textSecondary, fontSize: 9.5, marginTop: 1 },
  legend: { flex: 1, gap: 10 },
  legendRow: { flexDirection: 'row', alignItems: 'center' },
  legendLeft: { flexDirection: 'row', alignItems: 'center', gap: 6, flex: 1 },
  dot: { width: 8, height: 8, borderRadius: 4 },
  legendLabel: { color: colors.textPrimary, fontSize: 10, flexShrink: 1 },
  legendValue: { color: colors.textPrimary, fontSize: 9, fontWeight: '600', marginRight: 8 },
  legendPct: { color: colors.textSecondary, fontSize: 9, width: 38, textAlign: 'right' },
  divider: { height: StyleSheet.hairlineWidth, backgroundColor: colors.border, marginTop: 14, marginBottom: 10 },
  viewAllRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  viewAllText: { color: colors.primaryLight, fontSize: 10, fontWeight: '600' },
});
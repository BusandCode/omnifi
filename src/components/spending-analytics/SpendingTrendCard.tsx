      ...
      <View style={styles.statsRow}>
        <View style={[styles.statCard, { backgroundColor: 'rgba(255,59,48,0.08)' }]}>
          <View style={[styles.statIcon, { backgroundColor: 'rgba(255,59,48,0.15)' }]}>
            <Feather name="trending-up" size={13} color={colors.danger} />
          </View>
          <View>
        ...
        <View style={[styles.statCard, { backgroundColor: 'rgba(52,199,89,0.08)' }]}>
          <View style={[styles.statIcon, { backgroundColor: 'rgba(52,199,89,0.15)' }]}>
            <Feather name="trending-down" size={13} color={colors.success} />
          </View>
          <View>
...
const styles = StyleSheet.create({
  ...
  periodText: { color: colors.textPrimary, fontSize: 10.5, fontWeight: '600' },
  chartRow: { flexDirection: 'row' },
  yAxis: { justifyContent: 'space-between', paddingRight: 6, paddingBottom: 4 },
  yLabel: { color: colors.textSecondary, fontSize: 8.5 },
  xAxisRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4, paddingLeft: 34 },
  xLabel: { color: colors.textSecondary, fontSize: 8.5 },
  ...
  statValue: { color: colors.textPrimary, fontSize: 12, fontWeight: '700', marginTop: 2 },
  statDate: { color: colors.textSecondary, fontSize: 8.5, marginTop: 1 },
});
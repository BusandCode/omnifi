...
export function DataPlanGrid({ plans, selected, onSelect }: Props) {
  ...
  cardActive: { borderColor: themeColors.primary, backgroundColor: 'rgba(167,139,250,0.15)' },
  popularTag: {
    position: 'absolute', top: -8, right: 6,
    backgroundColor: themeColors.primary, paddingHorizontal: 5, paddingVertical: 1.5, borderRadius: 5,
  },
  popularText: { color: '#fff', fontSize: 7, fontWeight: '700' },
  checkBadge: {
    position: 'absolute', top: 6, right: 6,
    width: 16, height: 16, borderRadius: 8, backgroundColor: themeColors.primary,
    justifyContent: 'center', alignItems: 'center',
  },
  size: { color: themeColors.textPrimary, fontSize: 12.5, fontWeight: '700', marginBottom: 4 },
  validity: { color: themeColors.textSecondary, fontSize: 8.5, marginBottom: 4 },
  price: { color: themeColors.textPrimary, fontSize: 10.5, fontWeight: '600' },
  priceActive: { color: themeColors.primaryLight },
}),
    [themeColors]
  );

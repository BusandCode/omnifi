  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {/* TODO: wire onRowPress once app/account-limits/[key].tsx exists */}
        ...
        {/* TODO: wire onContactSupport once app/support.tsx exists */}
        <AccountLimitsFooter
          ...
          onCtaPress={
            config.tier < 3
              ...
              : undefined // Tier 3 CTA is "View Premium Benefits" — needs its own screen, not the upgrade flow
          }
        />
      </ScrollView>
    </View>

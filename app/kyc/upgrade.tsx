...
const REQUIREMENTS_BY_TARGET: Record<
  "2" | "3",
  { heading: string; blurb: string; items: Requirement[] }
> = {
  "2": {
    heading: "Upgrade to Tier 2",
    blurb:
      "Verify your identity to unlock higher transfer limits and unlimited wallet balance.",
    items: [
      {
        key: "bvn",
        icon: CreditCard,
        title: "Link your BVN",
        sub: "Used to confirm your identity with your bank",
      },
      {
        key: "id",
        icon: FileText,
        title: "Valid government ID",
        sub: "NIN slip, driver\u2019s license, or international passport",
      },
    ],
  },
  "3": {
    ...
    blurb:
      "Complete premium verification to unlock unlimited limits and priority support.",
    items: [
      {
        key: "address",
        icon: MapPin,
        title: "Proof of address",
        sub: "Utility bill or bank statement, issued within 3 months",
      },
      {
        key: "video",
        icon: Video,
        title: "Video verification",
        sub: "A short live selfie video to confirm it\u2019s really you",
      },
      {
        key: "id",
        icon: FileText,
        title: "Valid government ID",
        sub: "Must match the details on your Tier 2 verification",
      },
    ],
  },
};
      ...
      >
        ...
        <View style={styles.card}>
          {config.items.map((item, idx) => (
            <View
              ...
              style={[
                styles.row,
                idx !== config.items.length - 1 && styles.rowDivider,
              ]}
            >
        ...
        <Pressable
          ...
          onPress={() => {
            ...
            useAuthStore.getState().setAccountTier(Number(targetKey) as 2 | 3);
            router.replace("/account-limits");
          }}
        >
          <LinearGradient
